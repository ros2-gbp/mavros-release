## mavros (rolling) - 2.15.1-1

The packages in the `mavros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling mavros` on `Sat, 22 Aug 2026 11:30:19 -0000`
...
## mavros (lyrical) - 2.15.1-1

The packages in the `mavros` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release -r lyrical mavros` on `Sat, 22 Aug 2026 11:28:56 -0000`
...
## mavros (kilted) - 2.15.1-1

The packages in the `mavros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted mavros` on `Sat, 22 Aug 2026 11:27:14 -0000`
...
## mavros (jazzy) - 2.15.1-1

The packages in the `mavros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy mavros` on `Sat, 22 Aug 2026 11:23:49 -0000`
...
## mavros (humble) - 2.15.1-1

The packages in the `mavros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble mavros` on `Sat, 22 Aug 2026 11:14:06 -0000`
...
## mavros (rolling) - 2.15.0-1

The packages in the `mavros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling mavros` on `Sat, 08 Aug 2026 10:17:14 -0000`
...
## mavros (lyrical) - 2.15.0-1

The packages in the `mavros` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release -r lyrical mavros` on `Sat, 08 Aug 2026 10:16:05 -0000`
...
- upstream repository: https://github.com/mavlink/mavros.git
- release repository: https://github.com/ros2-gbp/mavros-release.git
- rosdistro version: `2.14.0-3`
- old version: `2.14.0-3`
- new version: `2.15.0-1`
...
## mavros (kilted) - 2.15.0-1

The packages in the `mavros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted mavros` on `Sat, 08 Aug 2026 10:14:57 -0000`
...
## mavros (jazzy) - 2.15.0-1

The packages in the `mavros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy mavros` on `Sat, 08 Aug 2026 10:13:37 -0000`
...
## mavros (humble) - 2.15.0-1

The packages in the `mavros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble mavros` on `Sat, 08 Aug 2026 10:12:08 -0000`
...
## mavros (rolling) - 2.14.0-1

The packages in the `mavros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling mavros` on `Tue, 23 Dec 2025 12:15:48 -0000`
...
## mavros (kilted) - 2.14.0-1

The packages in the `mavros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted mavros` on `Tue, 23 Dec 2025 12:10:55 -0000`
...
## mavros (jazzy) - 2.14.0-1

The packages in the `mavros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy mavros` on `Tue, 23 Dec 2025 12:05:42 -0000`
...
## mavros (humble) - 2.14.0-1

The packages in the `mavros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble mavros` on `Tue, 23 Dec 2025 11:26:47 -0000`
...
## mavros (rolling) - 2.13.0-1

The packages in the `mavros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release -r rolling mavros` on `Fri, 12 Dec 2025 15:37:48 -0000`
...
## mavros (kilted) - 2.13.0-1

The packages in the `mavros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release -r kilted mavros` on `Fri, 12 Dec 2025 15:16:54 -0000`
...
## mavros (jazzy) - 2.13.0-1

The packages in the `mavros` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release -r jazzy mavros` on `Fri, 12 Dec 2025 15:06:50 -0000`
...
## mavros (humble) - 2.13.0-1

The packages in the `mavros` repository were released into the `humble` distro by running `/usr/bin/bloom-release -r humble mavros` on `Fri, 12 Dec 2025 14:21:35 -0000`
...
## mavros (rolling) - 2.12.0-1

The packages in the `mavros` repository were released into the `rolling` distro by running `/usr/bin/bloom-release mavros -r rolling` on `Sun, 14 Sep 2025 08:09:12 -0000`
...
## mavros (kilted) - 2.12.0-1

The packages in the `mavros` repository were released into the `kilted` distro by running `/usr/bin/bloom-release mavros -r kilted` on `Sun, 14 Sep 2025 07:59:38 -0000`
